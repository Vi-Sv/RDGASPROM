Sub ExtractDataFinal()
    ...
    wsSource.Cells.Replace What:="Наименование вида работ", Replacement:="", LookAt:=xlPart, MatchCase:=False
    ...
    For i = 1 To lastRow
        ...
        If Trim(CStr(cellD.Value)) <> "" Then
            ...
            Else
                ...
                j = i + 1
                Do While j <= lastRow And Trim(CStr(wsSource.Cells(j, "D").Value)) = ""
